...
export type ConvertibleFormat = 'text' | 'pdf' | 'docx' | 'xlsx' | 'xls' | 'pptx' | 'html' | 'epub' | 'csv' | 'json' | 'xml' | 'zip';
/** A human-readable label for the detected format. */
export declare const FORMAT_LABELS: Record<ConvertibleFormat, string>;
